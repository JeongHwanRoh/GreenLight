...
## 📌 프로젝트 소개
'스마트 AI 신호등'은 야간 보행자의 안전을 보장하기 위해 AI 기반 객체 인식 기술을 활용하여 실시간 신호 제어 및 경고 서비스를 제공합니다.  
교통사고 발생률이 높은 야간 시간대에 보행자와 운전자의 안전을 동시에 확보하고, 데이터 기반의 교통 관리 효율성을 증진하는 것을 목표로 합니다.
...
- **개발 배경**: 
  - 야간 보행자의 가시성 저하로 인한 교통사고 발생률 증가
...
- **Backend**: Django (웹 애플리케이션 개발 및 RESTful API 제공)
...
## 🌟 주요 기능
- [x] **AI 객체 탐지 및 실시간 신호 제어**
  - YOLOv10 모델을 활용한 보행자 및 차량 감지
  - 상황별 실시간 신호등 전환 및 제어
- [x] **위반 차량 감지 및 경고 시스템**
  - 신호 위반 및 속도 위반 차량 감지
  - gTTS를 통한 음성 알림 및 빨간 신호 전환
- [x] **데이터 수집 및 시각화**
  - 차량 및 보행자 통행량, 위반 비율 데이터 자동 저장
  - 데이터 기반 대시보드 시각화 및 통계 분석
- [x] **스마트 시티 연계 가능성**
  - 교통 데이터 누적 및 통계 분석
  - 국토교통부 및 경찰청 연계 가능
