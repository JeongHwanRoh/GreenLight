...
from road.models import Road # type: ignore
from vehicle.models import Vehicle, Speed, Signal # type: ignore
from pedestrian.models import Pedestrian # type: ignore

# test2 module import (event function control)
from update_xml import test # type: ignore
